...
-- INSERT VOZILA (10)
-- ===========================
INSERT INTO vozilo (marka, model, godina, cijena_dan, status) VALUES
(N'Volkswagen', N'Golf', 2018, 45.50, 1),
(N'Toyota', N'Corolla', 2020, 50.00, 1),
(N'BMW', N'320i', 2019, 70.00, 1),
(N'Audi', N'A4', 2021, 75.00, 1),
(N'Mercedes', N'C200', 2017, 65.00, 0),
(N'Ford', N'Focus', 2016, 40.00, 1),
(N'Opel', N'Astra', 2019, 48.00, 1),
(N'Nissan', N'Qashqai', 2020, 60.00, 1),
(N'Peugeot', N'308', 2018, 42.50, 0),
(N'Renault', N'Megane', 2021, 55.00, 1);
GO

-- ===========================
-- INSERT KLIJENATA (10)
-- ===========================
INSERT INTO klijent (ime, prezime, telefon, br_dokumenta) VALUES
(N'Amir', N'Hadzić', '061123456', 12345678),
(N'Selma', N'Jahić', '062234567', 23456789),
(N'Adnan', N'Čengić', '063345678', 34567890),
(N'Lejla', N'Begović', '060456789', 45678901),
(N'Denis', N'Mujić', '061567890', 56789012),
(N'Emir', N'Alispahić', '062678901', 67890123),
(N'Nina', N'Šarić', '063789012', 78901234),
(N'Haris', N'Kovačević', '060890123', 89012345),
(N'Aida', N'Ćatić', '061901234', 90123456),
(N'Mirza', N'Hadžiahmetović', '062012345', 11234567);
GO

-- ===========================
-- INSERT REZERVACIJA (10)
-- ===========================
INSERT INTO rezervacija (vozilo_id, klijent_id, datum_kreiranja, datum_od, datum_do, ukupna_cijena) VALUES
